...
public class LoginSuccess extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String randomGreeting = faker.company().catchPhrase();
		...
		// Display the random greeting generated by JavaFaker
		out.println("<br/><br/><font color=blue>Today's motivational message: " + randomGreeting + "</font>");
